...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Turkar</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Travel comfortably, with people you trust.</h1>
  ...
  <main id="main">
        ...
        <div class="row content">
          <div class="col-lg-6">
            ...
            <ul>
              ...
              <li><i class="ri-check-double-line"></i> 39 DISTRICTS</li>
              <li><i class="ri-check-double-line"></i> 14000 travelers per quarter</li>
            </ul>
          </div>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("assets/img/carp.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="assets/img/carp3.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <span class="skill">Traffic Congestion Reduction <i class="val">30%</i></span>
              ...
              <div class="progress">
                <span class="skill">Emission Reduction <i class="val">25%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">Fuel Efficiency Improvement <i class="val">15%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">Modal Shift Impact <i class="val">20%</i></span>
                <div class="progress-bar-wrap">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Turkar goes beyond navigation by providing a comprehensive range of services to improve your journey. Turkar is your one-stop shop for a seamless, sustainable, and connected urban experience, with features such as real-time traffic alerts, smart parking assistance, eco-driving suggestions, and community participation. Join us in reshaping the future of mobility, with each service designed to improve your commute while also contributing to a greener, more efficient city.</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Establish a community platform within the app where users can share tips, experiences, and feedback, fostering a sense of community and collaboration.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">User Profiles</a></h4>
              <p>Allow users to schedule rides in advance, providing flexibility for both riders and drivers.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Carpooling Communities</a></h4>
              <p>Create or join communities based on common interests, workplaces, or other criteria to enhance the social aspect of carpooling.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">Ride History and Receipts</a></h4>
              <p>Provide a record of past rides, including details such as date, time, route, and cost, and generate receipts for each transaction.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Turkar, your ultimate companion in the urban area, revolutionizes your daily commute. Navigate with precision using real-time traffic updates, find parking effortlessly, and embrace sustainable choices with eco-driving tips. Join our community of forward-thinkers reshaping the future of urban mobility. Optimize your commute, reduce congestion, and breathe cleaner air. Transform your journey – Turkar, where every drive counts. Experience the future today – Get started with us now and unlock a smarter, greener way to navigate your city!</p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/AHMED.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/BANGOURA.jpeg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Ahmed BANGOURA</h4>
          ...
          <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/HAFID.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Hafid ALAOUI</h4>
                <span>CTO</span>
          ...
          <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/HICHAM.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Hicham Mounir</h4>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Discover the ins and outs of Turkar with our Frequently Asked Questions (FAQs) section. We've compiled essential information to address common queries and provide you with a comprehensive understanding of our app's features, functionalities, and benefits. Explore the details below to optimize your experience with Turkar. If you don't find the answer you're looking for, feel free to reach out to our dedicated customer support for further assistance.</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Have a question, feedback, or need assistance? We're here for you. Contacting Turkar is quick and easy. Reach out to our dedicated customer support team, and let us assist you with any inquiries or concerns. Your satisfaction is our priority, and we're committed to ensuring a smooth and enjoyable experience with Turkar. Connect with us – because your journey matters.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>YENİBOSNA, ZAFER MAHALLESİ, ISTANBUL, 34197</p>
              </div>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24085.54164485329!2d28.799516861699168!3d41.01009866638257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa48f6efb5e25%3A0x6428a269c2adee7c!2sYenibosna%20Merkez%2C%20Bah%C3%A7elievler%2FIstanbul%2C%20Turquie!5e0!3m2!1sfr!2sma!4v1705951670779!5m2!1sfr!2sma" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6">
            ...
            <p>Subscribe to our newsletter for exclusive updates and insights from Turkar. Elevate your commuting experience with the latest features and tips delivered right to your inbox!</p>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Turkar</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Created by <a href="#">AHMED SAFA</a>
      </div>
    </div>
  </footer><!-- End Footer -->
