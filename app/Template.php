...
<head>
    ...
    <!-- flag-icon-css -->
    <link rel="stylesheet" href="Public/plugins/flag-icon-css/css/flag-icon.min.css">
</head>
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="index.php?action=logout" class="btn btn-default btn-flat float-right">Sign out</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right p-0">
                        <a href="index.php?action=translateEnglish" class="dropdown-item">
                            <i class="flag-icon flag-icon-gb mr-2"></i> <?php echo _English; ?>
                        </a>
                        <a href="index.php?action=translateTurk" class="dropdown-item">
                            <i class="flag-icon flag-icon-tr mr-2"></i> <?php echo _Turk; ?>
                        </a>
                    </div>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Turkar</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="index.php?action=manageLocations" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Locations</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="index.php?action=trips" class="nav-link">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="#">Turkar</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
