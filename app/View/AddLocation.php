...
/**
 *the content of the add new Location page.
 */
?>
<?php $title = _New . " " . _Location; ?>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title"><?= _New . " " . _Location; ?></h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="index.php" method="POST" id="addLocation">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="action" name="action" value="addLocation">
                    </div>
                </div>
                <!-- /.card-body -->
