                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-0 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a title="<?= _Review; ?>" href="javascript:show(<?= $list[$i]->getId(); ?>)" class="btn btn-warning"><i class="fas fa-comment"></i></a>
                                            <a title="<?= _Payment; ?>" href="javascript:show(<?= $list[$i]->getId(); ?>)" class="btn btn-primary"><i class="fas fa-wallet"></i></a>
                                        </div>
                                    </td>
                                </tr>
                        <?php }
