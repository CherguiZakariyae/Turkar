...
$var = new Vehicle($_POST['id'], $_SESSION['idUser'], $_POST['name'], $_POST['brand'], $_POST['model'], $_POST['year'], $_POST['plateNumber'], $_FILES["picture"]["name"], $enable, date('d-m-y'));
$action->getService()->getPDOVehicle()->editVehicle($var);
